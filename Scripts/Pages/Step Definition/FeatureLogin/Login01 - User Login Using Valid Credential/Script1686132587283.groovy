...
WebUI.callTestCase(findTestCase('Pages/Login/Input Username'), [('username') : 'firstlast@email.com'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/HomePage/SuccessLogin'), [:], FailureHandling.STOP_ON_FAILURE)
